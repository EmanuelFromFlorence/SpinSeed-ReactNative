    ...
    <Col lg={9}>
      <Container id='Overview' className='my-3'>
        ...
        <p className='lead mb-3 mt-3'>
          SpinSeed is an admin dashboard template built with React 17.0.2.
          SpinSeed goes beyond usual admin templates and provides you entire
          intuitive programming framework. You can use SpinSeed to build any
          type of web applications like SAAS, CMS, financial dashboards, project
          management tools, etc.
        </p>
        <img
          className='img-responsive w-100 border mb-2 mt-2'
          src={dashboard}
          alt='screenshot'
        />
        <Link to='/template/dashboard' className='mb-3 mt-3'>
          Live demo
        </Link>
      </Container>
      <Container id='Features' className='my-3'>
        ...
        <ul className='mt-3 mb-3'>
          <li className='lead'>
            <i className='la la-check' /> Dozens of Pages
          </li>
          <li className='lead'>
            <i className='la la-check' /> Fully Responsive
          </li>
          <li className='lead'>
            <i className='la la-check' /> React 17 new
          </li>
          <li className='lead'>
            <i className='la la-check' /> 5 Charts Library
          </li>
          <li className='lead'>
      ...
      <Container id='Support' className='my-3'>
        ...
        <a
          ...
          className='btn btn-default fw-semi-bold mt-3 mb-3'
        >
          Support forum
        </a>
      </Container>
