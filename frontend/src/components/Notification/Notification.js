...
const notifications = {
  info: {
    icon: infoIcon,
    message:
      "<span class='body-2'>Info:</span> This alert needs your attention, but it's not important.",
    color: '#00A5FF',
  ...
  warning: {
    icon: warningIcon,
    message:
      "<span class='body-2'>Warning:</span> Best check yourself, you're not looking too good.",
    color: '#FFA100',
  ...
  success: {
    icon: successIcon,
    message:
      "<span class='body-2'>Success:</span> You successfully read this important alert message.",
    color: '#43BC13',
  ...
  error: {
    icon: dangerIcon,
    message:
      "<span class='body-2'>Danger:</span> Danger: Change this and that and try again.",
    color: '#FF4B23',
        ...
        <div className={s.messageContainer}>
          <span
            dangerouslySetInnerHTML={{
              __html: notifications[props.type].message,
            }}
          ></span>
        </div>
      </Alert>
