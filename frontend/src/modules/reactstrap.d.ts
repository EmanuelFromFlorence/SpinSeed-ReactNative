declare module 'reactstrap' {
  ...
  export class CardImgOverlay extends React.Component<
    BaseCardProps,
    JSX.Element
  > {}
  ...
  export class InputGroupText extends React.Component<
    InputGroupTextProps,
    JSX.Element
  > {}
  ...
  export class InputGroupAddon extends React.Component<
  ...
  export class InputGroupButton extends React.Component<
  ...
  export class PopoverTitle extends React.Component<
    PopoverTitle,
    JSX.Element
  > {}
  ...
  export class PopoverContent extends React.Component<
    PopoverContentProps,
    JSX.Element
  > {}
